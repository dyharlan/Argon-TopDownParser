...
public class SyntaxTree {
    ...
    public BooleanNode condition(ParseTreeNode conditionNode) {
        BooleanNode rightNode = null;
        BooleanNode leftNode = null;
    ...
    public BooleanNode boolval(ParseTreeNode boolvalNode) {
    ...
    public void loop(ParseTreeNode loopNode, StatementsNode root) { //unused
